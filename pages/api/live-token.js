...
function buildInstruction(s, products, vasEntries) {
  ...
  const languageRule =
    "Language: you are fluent in English, Hindi, Marathi, Gujarati, Malayalam, Tamil, Telugu, and Kannada. Respond in whichever of these languages (or a natural mix, such as Hindi-English/Hinglish) the rep actually speaks to you in — mirror their language naturally, matching their fluency and code-switching style. " +
    "If the rep explicitly asks you to switch languages (for example saying \"can we speak in Tamil\" or \"please talk in Marathi\"), immediately switch to that exact language for the rest of the conversation, even if you were speaking a different language a moment ago — treat this as a direct, important instruction from them, not just a hint. " +
    "If they switch language on their own mid-conversation without asking, mirror that too. Never insist on a single language yourself, and never comment on or make a big deal out of a language change — just switch and continue naturally, the way a real bilingual/multilingual person would.";
